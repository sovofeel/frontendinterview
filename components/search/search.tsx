...
function DocIcon(props) {
  return (
    <chakra.svg strokeWidth="2px" width="20px" height="20px" viewBox="0 0 20 20" {...props}>
      <path
                  ...
                  return (
                    <Link key={item.id} href={item.url}>
                      <Box
                        ...
                        minH="60px"
                      >
                        {isLvl1 ? <DocIcon opacity={0.3} /> : <HashIcon opacity={0.3} />}

                        <Box flex="1" ml="3">
                          {!isLvl1 && (
                            <Box fontWeight="medium" fontSize="xs" opacity={0.6}>
                              {item.hierarchy.lvl1}
                            </Box>
                          )}
